...
void MyWindow::initSimulator(){
    ...
    switch(simulator_pid)
    {
        ...
        case 0 : /* child is going to be the simulator, it is the writer */
            ...
            sprintf( fdstr, "-g %d", pfd[1] );
            //printf("Here is GUI : %d\n", pfd[1]);

            /* execl is used to launch the simulator */
            execl( "../../Debug/Cunetsim", "Cunetsim", fdstr, NULL );
            perror( "execl" );
    }

    //suite de la fonction init, le pere ecoute - commentaire a modifier et code ci-dessous
