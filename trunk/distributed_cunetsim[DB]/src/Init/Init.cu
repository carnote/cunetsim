...
void Init_simulation_parameters(){
	...
	// cette partie a enlever en distribue !!!
	simulation_parameters.topology_config.area.x_km = 1.6;
	simulation_parameters.topology_config.area.y_km = 1.6;
	...
	for (int part = 0; part < 4; part++) {
		...
		simulation_parameters.distributed_simulation_config.partitions[part].conversion_table[1] = 50;
		simulation_parameters.distributed_simulation_config.partitions[part].conversion_table[2] = 100;
		simulation_parameters.distributed_simulation_config.partitions[part].conversion_table[3] = 150;
		
		// for the moment node_number and area dimensions are the same for all the partitions
		simulation_parameters.distributed_simulation_config.partitions[part].area_x = 0.4; //has to be deduced from the masters nb
		simulation_parameters.distributed_simulation_config.partitions[part].area_y = 1.6;
		simulation_parameters.distributed_simulation_config.partitions[part].area_z = 0.2;
		simulation_parameters.distributed_simulation_config.partitions[part].node_number = 50;
		...
		simulation_parameters.distributed_simulation_config.partitions[part].total_node_number = 200;
	...
	//GPU ords
	simulation_parameters.distributed_simulation_config.partitions[0].gpu_ord = 0;
	simulation_parameters.distributed_simulation_config.partitions[1].gpu_ord = 0;
	simulation_parameters.distributed_simulation_config.partitions[2].gpu_ord = 1;
	simulation_parameters.distributed_simulation_config.partitions[3].gpu_ord = 1;

	//offsets
	simulation_parameters.distributed_simulation_config.partitions[0].offset = 0;
	simulation_parameters.distributed_simulation_config.partitions[1].offset = 50;
	simulation_parameters.distributed_simulation_config.partitions[2].offset = 100;
	simulation_parameters.distributed_simulation_config.partitions[3].offset = 150;
