...
struct Performances Random_sched(struct Partition partition, int f, float drop_prob, void *genV, int gui, MPI_Comm comm_masters, MPI_data_types mpi_types);
...
struct Performances Static_grid(struct Partition partition, int f, float drop_prob, void *gen, int gui, MPI_Comm comm_masters, MPI_data_types mpi_types);
